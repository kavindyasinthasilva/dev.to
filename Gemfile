...
group :development do
  ...
  gem "derailed_benchmarks", "~> 1.6", ">= 1.6.0", require: false # A series of things you can use to benchmark a Rails or Ruby app
  ...
  gem "guard", "~> 2.16", ">= 2.16.0", require: false # Guard is a command line tool to easily handle events on file system modifications
