...
gem "algoliasearch-rails", "~> 1.24", ">= 1.24.0" # Algolia Search is a hosted search engine capable of delivering real-time results from the first keystroke
...
gem "feedjira", "~> 3.1", ">= 3.1.0" # A feed fetching and parsing library
gem "figaro", "~> 1.1" # Simple, Heroku-friendly Rails app configuration using ENV and a single YAML file
gem "fog-aws", "~> 3.6", ">= 3.6.2" # 'fog' gem to support Amazon Web Services
...
gem "inline_svg", "~> 1.6", ">= 1.6.0" # Embed SVG documents in your Rails views and style them with CSS
...
gem "octokit", "~> 4.15", ">= 4.15.0" # Simple wrapper for the GitHub API
...
gem "reverse_markdown", "~> 1.4", ">= 1.4.0" # Map simple html back into markdown
...
gem "twilio-ruby", "~> 5.29", ">= 5.29.0" # The official library for communicating with the Twilio REST API
...
group :development do
  gem "better_errors", "~> 2.6", ">= 2.6.0" # Provides a better error page for Rails and other Rack apps
  ...
  gem "derailed_benchmarks", "~> 1.4", ">= 1.4.2", require: false # A series of things you can use to benchmark a Rails or Ruby app
  gem "erb_lint", "~> 0.0", ">= 0.0.30", require: false # ERB Linter tool
...
group :development, :test do
  ...
  gem "capybara", "~> 3.30", ">= 3.30.0" # Capybara is an integration testing tool for rack based web applications
  ...
  gem "rubocop-rails", "~> 2.4", ">= 2.4.0", require: false # Automatic Rails code style checking tool
...
group :test do
  ...
  gem "webdrivers", "~> 4.1", ">= 4.1.3" # Run Selenium tests more easily with install and updates for all supported webdrivers
