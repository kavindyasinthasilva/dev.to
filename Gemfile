...
gem "administrate", "~> 0.12", ">= 0.12.0" # A Rails engine that helps you put together a super-flexible admin dashboard
...
gem "carrierwave", "~> 2.0", ">= 2.0.2" # Upload files in your Ruby applications, map them to a range of ORMs, store them on different backends
...
gem "inline_svg", "~> 1.5", ">= 1.5.2" # Embed SVG documents in your Rails views and style them with CSS
...
gem "omniauth", "~> 1.9", ">= 1.9.0" # A generalized Rack framework for multiple-provider authentication
gem "omniauth-github", "~> 1.3", ">= 1.3.0" # OmniAuth strategy for GitHub
...
gem "sprockets", "~> 3.7", ">= 3.7.2" # Sprockets is a Rack-based asset packaging system
